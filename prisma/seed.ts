...
const MOVIES = [
    ...
    { slug: 'midnight-express-2', title: 'Полночный экспресс', year: 2023, country: 'Франция', director: 'Люк Моро', genres: [ 'триллер', 'нуар' ], durationMin: 112, description: 'Ночной поезд Париж — Стамбул, исчезнувший пассажир и проводница, которая знает больше, чем говорит. Классический нуар в современных декорациях.' },
    { slug: 'paper-cranes', title: 'Бумажные журавли', year: 2025, country: 'Япония', director: 'Хару Танака', genres: [ 'драма', 'семейный' ], durationMin: 104, description: 'Пожилой мастер оригами и его внучка-подросток учатся понимать друг друга через тысячу бумажных журавлей. Тихое, светлое кино о связи поколений.' },
    ...
    { slug: 'seventh-floor', title: 'Седьмой этаж', year: 2025, country: 'Южная Корея', director: 'Ким Чжи Хун', genres: [ 'триллер', 'детектив' ], durationMin: 109, description: 'В офисном здании каждую пятницу гаснет свет ровно на семь минут. Новый охранник решает выяснить почему. Герметичный триллер с двойным дном.' },
    ...
    { slug: 'glass-river', title: 'Стеклянная река', year: 2024, country: 'Канада', director: 'Эмили Росс', genres: [ 'драма', 'спорт' ], durationMin: 124, description: 'Бывшая чемпионка по гребле возвращается тренером в родной клуб на замерзающей реке. Спортивная драма без единого лишнего слова.' },
    ...
    { slug: 'zero-gravity-waltz', title: 'Вальс в невесомости', year: 2024, country: 'Великобритания', director: 'Оливер Грант', genres: [ 'фантастика', 'мелодрама' ], durationMin: 119, description: 'Двое техников орбитального отеля остаются одни на станции на полгода. Камерная история о любви на высоте четырёхсот километров.' },
