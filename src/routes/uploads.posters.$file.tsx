...
async function handlePoster(params: UploadParams, request: Request, head = false) {
...
export const Route = createFileRoute('/uploads/posters/$file')({
    server: {
        handlers: {
            GET: async ({ params, request }) => handlePoster(params, request),
            HEAD: async ({ params, request }) => handlePoster(params, request, true),
        },
    },
});
